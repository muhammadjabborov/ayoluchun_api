    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', thumbnails.fields.ImageField(null=True, upload_to='photos/%Y/%m/%d/', verbose_name='Photo')),
                ('get_thumbnails', thumbnails.fields.ImageField(null=True, upload_to='')),
                ...
                ('imkon_uz', models.CharField(max_length=255, verbose_name='Imkon')),
        ...
        migrations.AddField(
            model_name='user',
            name='position',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='account.jobposition', verbose_name='Job Position'),
        ),
        migrations.AddField(
            model_name='user',
            name='region',
